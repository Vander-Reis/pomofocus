...
<h3 align="center">
	O pomofocus e uma aplicação como cronômetro nas suas tarefas diarias.
</h3>

<p align="center">
	<img src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square"/>
	<img src="https://img.shields.io/github/last-commit/Vander-Reis/pomofocus?color=green"/>
	<img src="https://img.shields.io/github/languages/count/Vander-Reis/pomofocus?color=green"/>
</p>
...
## About
Além de Cronômetro, tem algumas funções de músicas para te ajudar a focar na suas tarefas diarias. 
...
```bash
$ git clone https://github.com/Vander-Reis/pomofocus
```

## Usage
To use this project, follow the steps above:
```bash
Após baixar o projeto, rodar em localhost.
```
